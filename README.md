...
- 📄 [Архитектурная документация (PDF)](docs/6IDE7_Architecture.pdf) — детальное описание компонентов
- 📄 [Концептуальное проектирование и архитектура (PDF)](docs/6IDE7_Concept_Architecture.pdf) — полное техническое задание
- 📖 [Концепция и архитектура](docs/ARCHITECTURE.md) — краткое описание

## Статус проекта

🚧 **В разработке** — Реализованы базовый GUI, система блоков, генерация кода.
...
| ✅ Alpha 0.3 | Выполнено | Генерация кода Python/JS/Rust |
| 🔄 Alpha 0.4 | В процессе | Сохранение/загрузка проектов, undo/redo |
